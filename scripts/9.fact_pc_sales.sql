---fact_pc_sales inserting primary key
   ...
   Constraint fk_Channel_ID 
			...
			References [PC_Sales_Staging_dtw].[dbo].[dim_Channel] (Channel_ID),
	Constraint fk_Date_ID
			Foreign key (Date_ID)
			References [PC_Sales_Staging_dtw].[dbo].[dim_Date] (Date_ID),
	Constraint fk_Location_ID
			Foreign key (Location_ID)
			References [PC_Sales_Staging_dtw].[dbo].[Dim_Location] (Location_ID),
	Constraint fk_Paymenty_ID
			Foreign key (Paymenty_ID)
			References [PC_Sales_Staging_dtw].[dbo].[dim_payment] (Paymenty_ID),
	Constraint fk_Store_ID
			Foreign key (Shop_ID)
			References [PC_Sales_Staging_dtw].[dbo].[dim_Store] (Shop_ID),
	Constraint fk_Priority_ID
			Foreign key (Priority_ID)
			References [PC_Sales_Staging_dtw].[dbo].[dim_Priority] (Priority_ID),
	Constraint fk_PC_make_ID
			Foreign key (PC_make_ID)
